...
export function addBrand(dataToSubmit, existingBrands){
    ...
    .then(response=>{
        let brands = [
            //existingBrands is the previous brands and we get it from grtbrands from reducers
            //and props is mentioned in manage_brands.
            ...existingBrands,
            response.data.brand
        ];
        return {
            success: response.data.success,
            //brands name same as in server getbrands route.
            brands
        }
    });
    return {
