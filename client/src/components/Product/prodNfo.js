...
const ProdNfo = (props) => {
            ...
            <div className="cart">
                <MyButton
                    ...
                    runAction={()=>{
                       ...
                       //inside ./index.js addToCartHnadler function is stored in addToCart.
                    }}
                />
            </div>
        </div>
    ...
    //./index.js inside <prodNfo> tag prodDetails id stored in detail.
    //props.detail from get_products reducers is stored in ProdDetail, while in ./index.js prodDetail is stored in detail. so use detail. evrywhere
